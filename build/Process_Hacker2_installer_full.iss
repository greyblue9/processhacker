...
;
; Last updated Sun May 17 13:10:33 +0300 2015, VictorVG @ VikSoft.Ru
; update script version up to v13.5.15 (non oficial).
;
; Requirements:
...
#define installer_build_number "13.5.15"
#define copyright              "Copyright © 2010-2015, Process Hacker Team. Licensed under the GNU GPL, v3."
...
Name: plugins\atomtable;             Description: {cm:comp_AtomTable};             Types: full custom;         Flags: disablenouninstallwarning; MinVersion: 6.0
Name: plugins\avgcpu;                Description: {cm:comp_AvgCPU};                Types: full custom;         Flags: disablenouninstallwarning; MinVersion: 6.0
Name: plugins\dbgview;               Description: {cm:comp_DbgView};               Types: full custom;         Flags: disablenouninstallwarning; MinVersion: 6.0
Name: plugins\dskdrivs;              Description: {cm:comp_DiskDrives};            Types: full custom;         Flags: disablenouninstallwarning
...
Name: plugins\hexpid;                Description: {cm:comp_HexPID};                Types: full custom;         Flags: disablenouninstallwarning; MinVersion: 6.0
Name: plugins\highlight;             Description: {cm:comp_Highlight};             Types: full custom;         Flags: disablenouninstallwarning; MinVersion: 6.0
...
Name: plugins\rotviewer;             Description: {cm:comp_ROTViewerPlugin};       Types: full custom;         Flags: disablenouninstallwarning; MinVersion: 6.0
Name: plugins\sbiesupport;           Description: {cm:comp_SbieSupport};           Types: full custom;         Flags: disablenouninstallwarning
Name: plugins\setcrtical;            Description: {cm:comp_SetCritical};           Types: full custom;         Flags: disablenouninstallwarning; MinVersion: 6.0
...
Name: plugins\WaitChain;             Description: {cm:comp_waitchain};             Types: full custom;         Flags: disablenouninstallwarning; MinVersion: 6.0
...
Source: ..\..\bin\Release32\plugins\AtomTablePlugin.dll;                 DestDir: {app}\plugins; Components: plugins\atomtable;             Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: ..\..\bin\Release64\plugins\AtomTablePlugin.dll;                 DestDir: {app}\plugins; Components: plugins\atomtable;             Flags: ignoreversion; Check: Is64BitInstallMode()
Source: ..\..\bin\Release32\plugins\AvgCpuPlugin.dll;                    DestDir: {app}\plugins; Components: plugins\avgcpu;                Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: ..\..\bin\Release64\plugins\AvgCpuPlugin.dll;                    DestDir: {app}\plugins; Components: plugins\avgcpu;                Flags: ignoreversion; Check: Is64BitInstallMode()
Source: ..\..\bin\Release32\plugins\DbgViewPlugin.dll;                   DestDir: {app}\plugins; Components: plugins\dbgview;               Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: ..\..\bin\Release64\plugins\DbgViewPlugin.dll;                   DestDir: {app}\plugins; Components: plugins\dbgview;               Flags: ignoreversion; Check: Is64BitInstallMode()
Source: ..\..\bin\Release32\plugins\DiskDrivesPlugin.dll;                DestDir: {app}\plugins; Components: plugins\dskdrivs;              Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: ..\..\bin\Release64\plugins\DiskDrivesPlugin.dll;                DestDir: {app}\plugins; Components: plugins\dskdrivs;              Flags: ignoreversion; Check: Is64BitInstallMode()
Source: ..\..\bin\Release32\plugins\DnsCachePlugin.dll;                  DestDir: {app}\plugins; Components: plugins\dnscache;              Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: ..\..\bin\Release64\plugins\DnsCachePlugin.dll;                  DestDir: {app}\plugins; Components: plugins\dnscache;              Flags: ignoreversion; Check: Is64BitInstallMode()
...
Source: ..\..\bin\Release32\plugins\HexPidPlugin.dll;                    DestDir: {app}\plugins; Components: plugins\hexpid;                Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: ..\..\bin\Release64\plugins\HexPidPlugin.dll;                    DestDir: {app}\plugins; Components: plugins\hexpid;                Flags: ignoreversion; Check: Is64BitInstallMode()
Source: ..\..\bin\Release32\plugins\HighlightPlugin.dll;                 DestDir: {app}\plugins; Components: plugins\highlight;             Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: ..\..\bin\Release64\plugins\HighlightPlugin.dll;                 DestDir: {app}\plugins; Components: plugins\highlight;             Flags: ignoreversion; Check: Is64BitInstallMode()
...
Source: ..\..\bin\Release32\plugins\NvGpuPlugin.dll;                     DestDir: {app}\plugins; Components: plugins\nvgpu;                 Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: ..\..\bin\Release64\plugins\NvGpuPlugin.dll;                     DestDir: {app}\plugins; Components: plugins\nvgpu;                 Flags: ignoreversion; Check: Is64BitInstallMode()
...
Source: ..\..\bin\Release32\plugins\PerfMonPlugin.dll;                   DestDir: {app}\plugins; Components: plugins\perfmon;               Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: ..\..\bin\Release64\plugins\PerfMonPlugin.dll;                   DestDir: {app}\plugins; Components: plugins\perfmon;               Flags: ignoreversion; Check: Is64BitInstallMode()
Source: ..\..\bin\Release32\plugins\ROTViewerPlugin.dll;                 DestDir: {app}\plugins; Components: plugins\rotviewer;             Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: ..\..\bin\Release64\plugins\ROTViewerPlugin.dll;                 DestDir: {app}\plugins; Components: plugins\rotviewer;             Flags: ignoreversion; Check: Is64BitInstallMode()
...
Source: ..\..\bin\Release32\plugins\SetCriticalPlugin.dll;               DestDir: {app}\plugins; Components: plugins\setcrtical;            Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: ..\..\bin\Release64\plugins\SetCriticalPlugin.dll;               DestDir: {app}\plugins; Components: plugins\setcrtical;            Flags: ignoreversion; Check: Is64BitInstallMode()
...
Source: ..\..\bin\Release32\plugins\waitchainPlugin.dll;                 DestDir: {app}\plugins; Components: plugins\waitchain;             Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: ..\..\bin\Release64\plugins\waitchainPlugin.dll;                 DestDir: {app}\plugins; Components: plugins\waitchain;             Flags: ignoreversion; Check: Is64BitInstallMode()
...
Type: files;      Name: {app}\plugins\DiskDrivesPlugin.dll;          Check: not IsComponentSelected('plugins\dskdrivs')              and IsUpgrade()
...
Type: files;      Name: {app}\plugins\HexPidPlugin.dll;              Check: not IsComponentSelected('plugins\gfxinfo')               and IsUpgrade()
Type: files;      Name: {app}\plugins\HighlightPlugin.dll;           Check: not IsComponentSelected('plugins\gfxinfo')               and IsUpgrade()
...
Type: files;      Name: {app}\plugins\SecurityExplorer.dll;          Check: not IsComponentSelected('plugins\securityexplorer')      and IsUpgrade()
